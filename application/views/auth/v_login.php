...
<body>
    <div class="login-container">
        <div class="login-card">
            ...
            <form action="<?= base_url('auth/cek_login') ?>" method="post" id="loginForm">
                <div class="form-group">
                    <label class="form-label">Username</label>
                    <div class="input-wrapper">
                        <i class="fas fa-user input-icon"></i>
                        <input type="text" class="form-control" placeholder="Masukkan username" name="username" required autocomplete="username">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="password" id="password" class="form-control" name="password" placeholder="Masukkan password" required autocomplete="current-password" style="padding-right: 45px;">
